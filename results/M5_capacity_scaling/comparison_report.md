...
| **v2** | **small.en** | **244M** | **v2** | **0.4402** | **+18.35 pts** |

Val samples: 361 | Absolute improvement: 0.1835 | Relative: 29.4%

## 3. Outcome Classification

**Breakthrough** (ΔWER = +18.35 pts vs v1.1)
...
*Note: WER > 1.0 indicates more error words than reference words, typically caused by heavy insertion/hallucination errors.*
...
- **Breakthrough:** +18.35 pts WER improvement over v1.1 (62.37% -> 44.02%)
